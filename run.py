...
def welcome():
 ...
 /| |_| |\ \/ _ \/ <|  \| |>\| |  _ /\| |\/| |/ \/ _ \/ <|  \| |>   
   ...
   (_") ("_)(__)  (__)(_")  (_/(__)__)  (./  \.) (__)  (__)(_")  (_/ 
    ...
    print(
        helpers.colors.BLUE + helpers.colors.UNDERLINE + helpers.colors.BOLD + "HANGMAN RULES\n" + helpers.colors.RESET +
    """
    ...
    input(helpers.colors.GREEN + "Press ENTER to continue..." + helpers.colors.RESET)
...
def get_user():
    """
    Function to call user_validation() and return a 
    validate username.
...
def game_category(player_name):
    ...
    """
    print(f"{helpers.colors.BLUE}{helpers.colors.BOLD}{player_name}, please select 1 of 5 options below. If you're feeling lucky, choose the Hard option.{helpers.colors.RESET}\n")
    print("Enter " + helpers.colors.BLUE + helpers.colors.BOLD + "1 "  + helpers.colors.RESET + "for " + helpers.colors.BLUE + helpers.colors.BOLD + "ANIMALS" + helpers.colors.RESET)
    print("Enter " + helpers.colors.BLUE + helpers.colors.BOLD + "2 "  + helpers.colors.RESET + "for " + helpers.colors.BLUE + helpers.colors.BOLD + "CARS" + helpers.colors.RESET)
    print("Enter " + helpers.colors.BLUE + helpers.colors.BOLD + "3 "  + helpers.colors.RESET + "for " + helpers.colors.BLUE + helpers.colors.BOLD + "MOVIES" + helpers.colors.RESET)
    print("Enter " + helpers.colors.BLUE + helpers.colors.BOLD + "4 "  + helpers.colors.RESET + "for " + helpers.colors.BLUE + helpers.colors.BOLD + "SPORTS" + helpers.colors.RESET)
    print("Enter " + helpers.colors.BLUE + helpers.colors.BOLD + "5 "  + helpers.colors.RESET + "for " + helpers.colors.BLUE + helpers.colors.BOLD + "HARD\n" + helpers.colors.RESET)
    ...
    while not input_category:
        ...
        if category_choice == "1":
            ...
            print(f"{helpers.colors.RED}{helpers.colors.BOLD}You entered {category_choice}. Only numbers 1 to 5 are allowed\n")
...
def player_won(player_name, game_word):
    ...
    while not input_continue:
        ...
        if continue_choice == "Y":
            ...
            print(f"You entered {continue_choice}. Only letters Y or N are allowed\n")
...
def play_hangman(player_name, play_game, category):
    ...
    print(helpers.colors.YELLOW + helpers.display_hangman(attempts) + helpers.colors.RESET)

    while play_game == "Y" and attempts <= 5:
        player_guess = input(helpers.colors.GREEN + "Please guess a single letter or take a chance entering the complete word\n"+ helpers.colors.RESET).upper()
        helpers.clear_terminal()
        ...
        if len(player_guess) == len(game_word) and player_guess != game_word and player_guess.isalpha() and player_guess not in words_guessed:
            ...
            attempts += 1
            print(f"{helpers.colors.BLUE}{helpers.colors.BOLD}{player_guess} is not the hidden word {player_name}. You have depleted {attempts} of 6 attempts!{helpers.colors.RESET}")
            ...
            for letter in player_guess:
                ...
                if letter not in game_word:
                    attempts += 1
                    print(f"{helpers.colors.BLUE}{helpers.colors.BOLD}{player_guess} is not a letter in the hidden word {player_name}. You have depleted {attempts} of 6 attempts!{helpers.colors.RESET}")
                    ...
                    print(f"{helpers.colors.BLUE}{helpers.colors.BOLD}Nice one {player_name}! You have depleted {attempts} of 6 attempts.{helpers.colors.RESET}")
        ...
        print(helpers.colors.YELLOW + helpers.display_hangman(attempts) + helpers.colors.RESET)
        print(f"Hidden Word: {helpers.colors.CYAN} "+" ".join(display_word) + "\n")
        print(f"{helpers.colors.RESET}Words Guessed: {helpers.colors.CYAN} "+" ".join(words_guessed) + "\n")
        print(f"{helpers.colors.RESET}Letters Guessed: {helpers.colors.CYAN} "+" ".join(sorted(letters_guessed)) + "\n")  
